...
bot = telebot.TeleBot('7630760934:AAFlihbUAaRanW5ueQMWcYT5hwqczDGeaDE')

# Admin user IDs
admin_id = ["7770877438,7170752236"]
...
def check_authorization(func):
    def wrapper(message):
        ...
        if user_id not in allowed_user_ids and user_id not in admin_id:
            bot.reply_to(message, "♻️ENTER YOUR VVIP KEY🔑\n❌IF YOU DON'T HAVE KEY DM TO BUY:- @MR_NB_OWNER\n 🤖 OFFICIAL CHANNEL:- https://t.me/+plAOkpDCRqw2MmU1 :")
...
def authorize_user(message, func):
    ...
    if is_key_valid(message.text):
        ...
        bot.reply_to(message, "❌YOU HAVE NO KEY DM TO BUY @MR_NB_OWNER🚀")    
